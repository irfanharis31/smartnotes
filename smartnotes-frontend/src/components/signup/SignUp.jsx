...
function SignUp() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3000/user-api/users', {
        method: 'POST',
        headers: {
    ...
    <div className='w-96 mb-10'>
      <div className='w-full mx-4 bg-white shadow-lg rounded-lg overflow-hidden'>
        ...
        <form className='p-6' onSubmit={handleSubmit}>
          ...
          <div className='mb-4'>
            <label htmlFor="confirmNotesPassword" className='block text-lg font-bold text-gray-700 mb-2'>Confirm Notes Password:</label>
            <input
              type="password"
